 ...
 * @UniqueEntity("email", groups={"user:create"})
 */
class User implements EntityInterface, UserInterface
{
     ...
     * @Groups({"user:index", "user:get", "user:create"})
     * @Assert\Email()
     * @Assert\NotBlank()
     */
    private $email;
     ...
     * @Groups({"user:index", "user:get", "user:create", "user:update", "tenant:get"})
     */
    private $phone;
